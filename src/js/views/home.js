    ...
    <Container className="">
      <Row className="d-flex justify-content-center align-items-center">
        ...
        <Col center>
          ...
          <br />
          <p>
            Aquí encontrarás psicólogos que te ayudarán a alcanzar las soluciones que necesitas. Da el primer paso,
            contacta y accede a un servicio profesional, de calidad y orientado a resultados.
          </p>
