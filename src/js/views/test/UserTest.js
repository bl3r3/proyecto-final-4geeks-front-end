				...
				<div className="btn-wizard">
					{formStep === 0 ? null : formStep === 1 ? null : (
						<button
							...
							type="button"
							className="btn-radius btn btn-warning">
							Regresar
						</button>
					)}
					<button
						...
						{formStep >= 0 && (
							<section className={formStep === 0 ? "test-active" : "d-none"}>
								<div className="w-100">
									...
									<h3>
										Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed dictum condimentum
										sodales. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per
										inceptos himenaeos. Donec ultrices tincidunt blandit. Phasellus nec nunc
										molestie sapien eleifend consequat vel ut nisi.
									</h3>
								</div>
							</section>
						)}
