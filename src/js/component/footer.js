      ...
      <Row>
        <Col md={3} className="d-flex align-items-center justify-content-center">
          <div className="custom-paragraph">
            <p>
              Plataforma para gestión de servicios psicológicos, que busca acercar al prestador del servicio y al
              usuario que requiera una atención psicológica personalizada.
            </p>
          </div>
        </Col>
